...
const cardLimit = games.length; // Nombre de jeux basé sur le nombre d'index dans le tableau d'objets 'Games'
...
const createCard = (i) => {
  ...
  const cardContent = gamesDetails(i);
...
const addCards = (pageIndex) => {
  ...
  const endRange = Math.min(pageIndex * cardIncrease, cardLimit);
...
const handleInfiniteScroll = () => {
  ...
  const triggerHeight = window.innerHeight * 0.2; 
   const endOfPage =
     window.innerHeight + window.scrollY >= cardContainer.offsetHeight - triggerHeight;
