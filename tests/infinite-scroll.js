...
// const collectionGames = function fetchCollectionData() {
...
// import data from './json/collection.json' assert { type: 'json' };
// console.log(data);
...
const pageCount = Math.ceil(cardLimit / cardIncrease); // Calcul du nombre total de pages
let currentPage = 1; 
let lastScrollTop = 0;
let throttleTimer;
...
function gamesDetails(i) {
  ...
  let splittedUrl = currentUrl.split('/').pop();
